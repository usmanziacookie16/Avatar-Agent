...
if (fs.existsSync('./config.json')) {
  ...
  console.log('Cw  Using environment variables (production mode)');
}
...
`,
      ...
      openaiWs.on('message', (data) => {
        ...
        // --- VAD EVENTS (CRITICAL FOR AVATAR ANIMATION) ---

        // User started speaking
        if (event.type === 'input_audio_buffer.speech_started') {
          console.log('🎤 User started speaking');
          
          // NOTIFY CLIENT IMMEDIATELY to switch to "LISTEN" animation
        ...
        if (event.type === 'input_audio_buffer.speech_stopped') {
          ...
          // NOTIFY CLIENT IMMEDIATELY to switch to "THINK" animation
